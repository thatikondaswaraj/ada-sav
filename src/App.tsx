...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white-900 flex flex-col items-center justify-center  relative overflow-hidden p-6">
      ...
      >
        <SearchInput searchedUrl={(url: string) => setUrl(url)} />
      </motion.div>
